...
#define STORAGE_BUCKET_ID "BUCKET-NAME.appspot.com"//from storage 

/* 3 The following Service Account credentials required for OAuth2.0 authen in Google Cloud Storage JSON API download */
#define FIREBASE_PROJECT_ID "AIzaSyDo_mgt8xoNbViJ8h899Nh_NYTZJIBAEug"//From project setting 
#define FIREBASE_CLIENT_EMAIL " ahmedfathy11875@gmail.com "
const char PRIVATE_KEY[] PROGMEM = "-----BEGIN PRIVATE KEY-----123456789-----END PRIVATE KEY-----\n";
...
void setup()
{
    ...
    // Large data transmission may require larger RX buffer, otherwise the connection issue or data read time out can be occurred.
