...
#define FIREBASE_API_KEY "AIzaSyCR1rMFESAku2pycIedLJFEEtGZK-WXmXg"
#define FIREBASE_RTDB_URL "esp32ota-9f8da-default-rtdb.firebaseio.com"
#define FIREBASE_USER_EMAIL "ehabmagdy0404@gmail.com"
    ...
    if (Firebase.ready())
    {
        ...
        if(Firebase.RTDB.getString(&fbdo, "/update/version"))
        {
            ...
            if(update_version > 0)
            {
                ...
                else{ Serial .print("Firebase: "); Serial.println(fbdo.errorReason().c_str()); }
            }
...
void loop()
{
    ...
    // Sending Sensors Data to Azure IoT Hub
    sendTelemetry();
